...
const contactTranslations: Record<Lang, {
  ...
  en: {
    ...
    sending: "Opening...",
    sent: "Sent",
    sentMsg: "Your email client should have opened. If not, you can reach me at",
    intro: (Hl) => <>
  ...
  de: {
    ...
    sending: "\u00D6ffne...",
    sent: "Gesendet",
    sentMsg: "Ihr E-Mail-Client sollte sich ge\u00F6ffnet haben. Falls nicht, erreichen Sie mich unter",
    intro: (Hl) => <>
  ...
  fr: {
    ...
    sending: "Ouverture...",
    sent: "Envoy\u00E9",
    sentMsg: "Votre client email devrait s\u2019\u00EAtre ouvert. Sinon, vous pouvez me contacter \u00E0",
    intro: (Hl) => <>
  ...
  ko: {
    ...
    sending: "\uC5EC\uB294 \uC911...",
    sent: "\uC804\uC1A1\uB428",
    sentMsg: "\uC774\uBA54\uC77C \uD074\uB77C\uC774\uC5B8\uD2B8\uAC00 \uC5F4\uB838\uC5B4\uC57C \uD569\uB2C8\uB2E4. \uC5F4\uB9AC\uC9C0 \uC54A\uC558\uB2E4\uBA74 \uB2E4\uC74C \uC8FC\uC18C\uB85C \uC5F0\uB77D\uD574 \uC8FC\uC138\uC694",
    intro: (Hl) => <>
  ...
  id: {
    ...
    sending: "Membuka...",
    sent: "Terkirim",
    sentMsg: "Klien email Anda seharusnya sudah terbuka. Jika tidak, Anda bisa menghubungi saya di",
    intro: (Hl) => <>
  ...
  zh: {
    ...
    sending: "\u6253\u5F00\u4E2D...",
    sent: "\u5DF2\u53D1\u9001",
    sentMsg: "\u60A8\u7684\u90AE\u4EF6\u5BA2\u6237\u7AEF\u5E94\u5DF2\u6253\u5F00\u3002\u5982\u679C\u6CA1\u6709\uFF0C\u60A8\u53EF\u4EE5\u901A\u8FC7\u4EE5\u4E0B\u5730\u5740\u8054\u7CFB\u6211",
    intro: (Hl) => <>
  ...
  ja: {
    ...
    sending: "\u958B\u3044\u3066\u3044\u307E\u3059...",
    sent: "\u9001\u4FE1\u6E08\u307F",
    sentMsg: "\u30E1\u30FC\u30EB\u30AF\u30E9\u30A4\u30A2\u30F3\u30C8\u304C\u958B\u3044\u305F\u306F\u305A\u3067\u3059\u3002\u958B\u304B\u306A\u3044\u5834\u5408\u306F\u3001\u4EE5\u4E0B\u306E\u30A2\u30C9\u30EC\u30B9\u307E\u3067",
    intro: (Hl) => <>
...
export default function ContactForm({ onClose, lang = "en" }: { onClose: () => void; lang?: Lang }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const mailto = `mailto:reid@reidsurmeier.com?subject=${encodeURIComponent(subject || "Contact from website")}&body=${encodeURIComponent(mailtoBody)}`;
    ...
    <div style={{ height: "100%", display: "flex", flexDirection: "column", position: "relative" }}>
      ...
      >
        ...
        >
          ...
          >
            {status === "sending" ? ct.sending : status === "sent" ? ct.sent : ct.send}
          </button>
          ...
          {status === "sent" && (
            ...
            >
              {ct.sentMsg}{" "}
              <span style={{ color: "#666" }}>reid@reidsurmeier.com</span>
            </p>
          )}
        </form>
      </div>
